...
class PAppCompatAutoCompleteTextView @JvmOverloads constructor(
    ...
    init {
        initPAutoCompleteEditText(attrs)
    }


    private fun initPAutoCompleteEditText(attrs: AttributeSet?) {
        val typedArray = context.theme.obtainStyledAttributes(attrs, R.styleable.PAppCompatAutoCompleteTextView, 0, 0)

        try {

            with(typedArray) {
                getInt(R.styleable.PAppCompatAutoCompleteTextView_act_useTextColor,-1).also {
                ...
                //set hintTextColor
                getInt(R.styleable.PAppCompatAutoCompleteTextView_act_useHintTextColor,-1).also {
                    when (TextColorEnum.fromInt(it)){
                        TextColorEnum.Color0 ->{
                ...
                getInt(R.styleable.PAppCompatAutoCompleteTextView_act_useTextHeader, -1).also {
                ...
                getInt(R.styleable.PAppCompatAutoCompleteTextView_act_useFontStyle, -1).also {
