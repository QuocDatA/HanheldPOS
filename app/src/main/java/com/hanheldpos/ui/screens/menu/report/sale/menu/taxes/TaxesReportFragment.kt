...
class TaxesReportFragment : BaseFragment<FragmentTaxesReportBinding,TaxesReportVM>(), TaxesReportUV{
    ...
    override fun layoutRes(): Int {
        return R.layout.fragment_taxes_report
    }

    override fun viewModelClass(): Class<TaxesReportVM> {
        return TaxesReportVM::class.java
    }

    override fun initViewModel(viewModel: TaxesReportVM) {
        viewModel.run {
            init(this@TaxesReportFragment)
