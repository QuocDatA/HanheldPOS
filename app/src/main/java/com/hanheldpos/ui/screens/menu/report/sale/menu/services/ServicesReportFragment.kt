...
class ServicesReportFragment : BaseFragment<FragmentServicesReportBinding,ServicesReportVM>(), ServicesReportUV {
    ...
    override fun layoutRes(): Int {
        return R.layout.fragment_services_report
    }

    override fun viewModelClass(): Class<ServicesReportVM> {
        return ServicesReportVM::class.java
    }

    override fun initViewModel(viewModel: ServicesReportVM) {
        viewModel.run {
            init(this@ServicesReportFragment)
