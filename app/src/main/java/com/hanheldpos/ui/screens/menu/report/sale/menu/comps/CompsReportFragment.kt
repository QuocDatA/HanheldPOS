...
class CompsReportFragment(private val salesReport: ReportSalesResp?) : BaseFragment<FragmentCompsReportBinding, CompsReportVM>(),
    CompsReportUV {
    ...
    override fun layoutRes(): Int {
        return R.layout.fragment_comps_report
    }

    override fun viewModelClass(): Class<CompsReportVM> {
        return CompsReportVM::class.java
    }

    override fun initViewModel(viewModel: CompsReportVM) {
        viewModel.run {
            init(this@CompsReportFragment)
    ...
    override fun initData() {
        ...
        val comps = salesReport?.Comp
        viewModel.getCompsSummary(comps).let {
        ...
        viewModel.getCompsDetail(requireContext(), comps).let {
